...
public class BintraymeTestContainer extends TestContainer {

    public BintraymeTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/bintrayme/app.properties",
    ...
    public static class Common extends BintraymeTestContainer {

        public static final BintraymeTestContainer.Common INSTANCE = new BintraymeTestContainer.Common();
